...
class QuestionBank {
  ...
  List<Question> _questionBank = [
    ...
    Question(
      ...
      ['Vitamin A', 'Vitamin K', 'Vitamin C', 'Vitamin D'],
      2,
    ),
    Question(
  ...
  String getOption(int optionNumber) {
    return _questionBank[_questionNumber].option[optionNumber];
  }
